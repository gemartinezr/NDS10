...
try:
    print("Test 9 Emulator: Structured output, safe timing. Press Ctrl+C to stop.")
    while True:
        cycle_count += 1

        # Increase values slowly
        ...
        for pid, value in [(PID_RPM, current_rpm), (PID_SPEED, current_speed)]:
            ...
            if frame:
                ...
                bus.send(msg)
                time.sleep(0.01)  # small delay between PID responses

        time.sleep(0.07)  # emulate Freematics pacing

except KeyboardInterrupt:
    print("Stopping Test 9 Emulator.")
finally:
    bus.shutdown()
