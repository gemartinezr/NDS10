...
def build_response(pid, value):
    ...
    if pid == PID_RPM:
        ...
        raw = int(value * 20)  # reverse of A*256 + B / 20
        payload = [raw >> 8, raw & 0xFF]
...
try:
    ...
    for cycle in range(total_cycles):
        ...
        # Add smooth distance increment
        dtc_distance = cycle  # 1 unit per cycle (can adjust step)

        # Periodic changes every 3s
    ...
    print("Test 13 Emulator stopped.")
finally:
    bus.shutdown()
