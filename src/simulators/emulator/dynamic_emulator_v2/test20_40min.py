...
max_runtime_sec = 40 * 60  # 40 minutes
...
try:
    ...
    print(f"Test 20: Starting at {start_str}. Duration: 40 minutes.")
    ...
    while True:
        ...
        if elapsed_time >= max_runtime_sec:
            ...
            print(f"Test 20 completed at {end_str}.")
            break
    ...
    print("Test 20 Emulator stopped manually.")
finally:
    bus.shutdown()
