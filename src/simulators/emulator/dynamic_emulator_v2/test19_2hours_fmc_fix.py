...
cycle_20min = 20 * cycles_per_minute
...
try:
    print("Test 19: 2-hour emulator with monotonic signals every second. Press Ctrl+C to stop.")
    ...
    print("Test 19 Emulator stopped manually.")
finally:
    bus.shutdown()
